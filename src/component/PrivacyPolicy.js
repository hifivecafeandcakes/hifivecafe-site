    ...
    return (
        ...
        <div className='container-fluid' style={{ color: "black", backgroundColor: 'black', color: 'white' }}>
            ...
            <div style={{ paddingRight: '20px', paddingLeft: '20px', paddingBottom: '80px', lineHeight: '1.6', }}>
                ...
                <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use, or disclosure of your information, at any time, by contacting us at {process.env.REACT_APP_CONTACT_EMAIL} or mailing us at: {process.env.REACT_APP_ADDRESS}</p>
                ...
                <p>For more insight, you may also want to read the terms and conditions of Razorpay on <a href="https://razorpay.com" target="_blank">https://razorpay.com</a></p>
                ...
                <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at {process.env.REACT_APP_CONTACT_EMAIL} or by mail at {process.env.REACT_APP_ADDRESS}</p>
